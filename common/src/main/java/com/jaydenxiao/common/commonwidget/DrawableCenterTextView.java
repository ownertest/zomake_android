...
public class DrawableCenterTextView extends AppCompatTextView {
    ...
    public DrawableCenterTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        widths[0] = array.getDimensionPixelSize(R.styleable.DrawableCenterTextView_leftDrawableWidth, 0);
        widths[1] = array.getDimensionPixelSize(R.styleable.DrawableCenterTextView_topDrawableWidth, 0);
        widths[2] = array.getDimensionPixelSize(R.styleable.DrawableCenterTextView_rightDrawableWidth, 0);
        widths[3] = array.getDimensionPixelSize(R.styleable.DrawableCenterTextView_bottomDrawableWidth, 0);

        heights[0] = array.getDimensionPixelSize(R.styleable.DrawableCenterTextView_leftDrawableHeight, 0);
        heights[1] = array.getDimensionPixelSize(R.styleable.DrawableCenterTextView_topDrawableHeight, 0);
        heights[2] = array.getDimensionPixelSize(R.styleable.DrawableCenterTextView_rightDrawableHeight, 0);
        heights[3] = array.getDimensionPixelSize(R.styleable.DrawableCenterTextView_bottomDrawableHeight, 0);
